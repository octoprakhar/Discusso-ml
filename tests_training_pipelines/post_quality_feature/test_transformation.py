...
from ml.entity.post_quality_feature.config_entity import DataIngestionConfig,DataValidationConfig,DataTransformationConfig
...
print(
    "Effort train saved at:",
    transformation_artifact.effortDataTransformationArtifact.effort_features_train_path
)

print(
    "Openness train saved at:",
    transformation_artifact.opennessDataTransformationArtifact.openness_features_train_path
)