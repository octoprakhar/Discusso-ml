...
from ml.entity.post_quality_feature.config_entity import DataIngestionConfig,DataValidationConfig,DataTransformationConfig,ModelTrainerConfig
...
print(f"Trained model saved in {trainer_artifact.effort_model_path}")